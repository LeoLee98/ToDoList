...
Page({
  data: {
    ...
    targetTime1:"2019/12/21 08:30:00",
    targetTime2:"2019/11/24 09:00:00",
    timer : 1,
    time1: "",
    time2: ""
  ...
  //计算时间差
  timeDiff : function (d1) {//di作为一个变量传进来
  ...
  onLoad: function () {
    ...
    this.setData(
      {
        time1: this.timeDiff(this.data.targetTime1),
        time2: this.timeDiff(this.data.targetTime2)
      })
    this.data.timer = setInterval(function () {
      _this.setData(
        {
          time1: _this.timeDiff(_this.data.targetTime1),
          time2: _this.timeDiff(_this.data.targetTime2)
        }
      )
